...
export class PetApi extends runtime.BaseAPI {
   ...
   * Finds Pets by tags
   */
  async findPetsByTagsRaw(
    requestParameters: PetApiFindPetsByTagsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<Pet>>> {
    if (
      requestParameters.tags === null ||
      requestParameters.tags === undefined
    ) {
      throw new runtime.RequiredError(
        "tags",
